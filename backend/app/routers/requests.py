...
from ..services.ai_service import classify_request  # NEW IMPORT
...
async def create_request(
    ...
    """
    Create a new help request with AI classification
    """
    # Get user
    try:
    ...
    # AI Classification
    print(f"Classifying request: {request_data.description[:50]}...")
    classification = classify_request(request_data.description)
    print(f"Classification result: {classification}")
    
    # Create request with AI-determined values
    new_request = Request(
        user_id=user.id,
